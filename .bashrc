...
alias nix-clean="nix-store --optimise && nix-store --gc"
alias config="sudoedit nvim /etc/nixos/configuration.nix"
alias logid="sudo systemctl start logid"
alias wireshark="QT_STYLE_OVERRIDE=Adwaita-Dark wireshark"

# Android
export PATH=$HOME/Applications/android/cmdline-tools/9.0/bin:$PATH
...
export PATH=$HOME/downloads/squashfs-root/usr/bin/nvim:$PATH
export PATH=$PATH:/usr/local/go/bin
export ANDROID_SDK_ROOT=$HOME/drunkwhales/.android/sdk
export GTK_THEME=andromeda
